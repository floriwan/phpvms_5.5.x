...
*/
        ...
        \Codebird\Codebird::setConsumerKey(Config::get('TWITTER_CONSUMER_KEY'), Config::get('TWITTER_CONSUMER_SECRET'));
        $cb = \Codebird\Codebird::getInstance();
        $cb->setToken(Config::get('TWITTER_OAUTH_TOKEN'),Config::get('TWITTER_OAUTH_SECRET'));
