...
<table width="98%" align="center" cellpadding="4">
    ...
    <tr>
        <td width="50%" ><div id="<?php echo $schedule->depicao; ?>" class="metar"> <?php include 'include.php'; get_metar($schedule->depicao); ?> </div></td>
        <td width="50%" ><div id="<?php echo $schedule->arricao; ?>" class="metar"> <?php get_metar($schedule->arricao); ?></div></td>
    </tr>
    <tr>
        <td><a href="http://flightaware.com/resources/airport/<?php echo $schedule->depicao?>/weather" target="_blank"><i class="icon fa-cloud"></i> View Weather Details</a></td>
        <td><a href="http://flightaware.com/resources/airport/<?php echo $schedule->arricao?>/weather" target="_blank"><i class="icon fa-cloud"></i> View Weather Details</a></td>
    </tr>
...
<tr>
    <td><a href="http://flightaware.com/analysis/route.rvt?origin=<?php echo $schedule->depicao?>&destination=<?php echo $schedule->arricao?>">
      <img src="<?php echo fileurl('/images/logos/flightaware.png');?>" alt="Flightaware" title="FlightAware"> View recent IFR Routes data</a></td>
</tr>
<tr><td><a href="https://skyvector.com/?chart=304&zoom=6&fpl=<?php echo $schedule->depicao ; ?>%20%20<?php echo $schedule->arricao ; ?>" id="sklink" target="_blank">
            <img class="routeimg" src="<?php echo fileurl('/images/logos/routes_skv.png');?>" alt="SkyVector" title="SkyVector"></a></td>
</tr>
</table>
...
<input style="width:100%" type="button" onclick="simbriefsubmit('http://www.flycaribbeanva.com/phpvms/index.php/SimBrief');" style="font-size:30px" value="Generate Simbrief">
<!--<input type="button" onclick="schedule_briefing_simbrief" style="font-size:30px" value="Generate Simbrief">-->
