...
<table width="98%" align="center" cellpadding="4">
    ...
    <tr>
        <td width="50%" ><div id="<?php echo $schedule->depicao; ?>" class="metar"> <?php include 'include.php'; get_metar($schedule->depicao); ?> </div> <br />
            <a href="http://flightaware.com/resources/airport/<?php echo $schedule->depicao?>/weather" target="_blank">
            View Weather Details</a>
        </td>
        <td width="50%" ><div id="<?php echo $schedule->arricao; ?>" class="metar"> <?php get_metar($schedule->arricao); ?></div><br />
